...
public class C12_ArraydenTekrarlariSilme {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < arr.length; i++) {
            if (!tekrarsizList.contains(arr[i])) tekrarsizList.add(arr[i]);
        }
        System.out.println("tekrarsiz liste: "+tekrarsizList); // [1, 2, 4, 3, 5]
